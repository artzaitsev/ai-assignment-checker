...
def test_canonical_error_codes_are_enforced() -> None:
    ...
    assert is_canonical_error_code("normalization_parse_error") is True
...
def test_stage_error_mapping_restricts_invalid_codes() -> None:
    ...
    assert resolve_stage_error(stage="normalized", code="normalization_parse_error") == "normalization_parse_error"
...
def test_retry_classification_distinguishes_terminal_and_recoverable() -> None:
    ...
    assert classify_error("normalization_parse_error") == "recoverable"
